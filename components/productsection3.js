document.addEventListener("DOMContentLoaded", () => {
  ...
  function displayProducts() {
    ...
    productsToDisplay.forEach((product) => {
      ...
      col.className = "col-sm-12 col-md-6 col-lg-2 mb-2";
      row.appendChild(col);
  ...
  function displayPagination() {
    ...
    paginationContainer.innerHTML = ""; // Se limpia la paginación
  
    // Calcula el número total de páginas asegurándose de que sea al menos 1
    ...
    // Crea un contenedor para los botones de paginación
    ...
    // Establece el tipo de botón para evitar comportamiento por defecto de envío de formulario
