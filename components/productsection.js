document.addEventListener("DOMContentLoaded", () => {
  const products = [
    ...
    { name: "Producto 3", category: "cargadores", price: 30, img: "images/redmi13pro.jpg" },
    { name: "Producto 4", category: "cargadores", price: 30, img: "images/redmi13pro.jpg" },
    { name: "Producto 5", category: "cargadores", price: 30, img: "images/redmi13pro.jpg" },
    { name: "Producto 6", category: "cargadores", price: 30, img: "images/redmi13pro.jpg" },
  ];
